...
const PostsSection: FC = (): ReactElement => (
    <div className={styles.container}>
        ...
        <div className={styles.post}>
            ...
            <div className={styles.topic}>Anchor caf is dissappointing...
                <br />
                Honestly!!</div>
            <div className={styles.content}>
        ...
        <div className={styles.post}>
            ...
            <div className={styles.topic}>Hello, this semester is going by so fast, here are some tips to help new students struggling</div>
            <div className={styles.content}>
            <br/>Be confident
            <br/>Study hard, its never enough, study harder
            <br/>try to be social, nobody likes an antisocial creep
            <br/>do the right things at the right time
            Have a nice day
            </div>
        ...
        <div className={styles.post}>
            ...
            <div className={styles.content}>
             The 1st ca tests just got concluded, I hope we all did well? narate your experiences with this 1st ca, was it excellent or just there... or you... you know...banged?feel free to discuss
            </div>
